...
- Database schema — columns, constraints, indexes, enum values, nullability
...
- Public API contracts — routes, request/response shapes, error codes, webhook payloads
...
## How sure are you — say where each fact stopped
